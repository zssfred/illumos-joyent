...
extern int libvarpd_plugin_walk(varpd_handle_t, libvarpd_plugin_walk_f, void *);

extern int libvarpd_prop_handle_alloc(varpd_handle_t, varpd_instance_handle_t,
    varpd_prop_handle_t *);

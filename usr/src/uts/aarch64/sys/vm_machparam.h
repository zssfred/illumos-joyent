...
/*
 * USRTEXT is the start of the user text/data space. We leave the bottom 1 MB
 * unmapped on ARMv7.
 */
 ...
 * The default stack size (initial stack size limit) is chosen for consistency
 * with i86pc and sun4. Unlike those platforms, this does take up more entries
 * in the L1 page table.
 */
// #define	MAXSSIZ		(0x7ffff000)	/* max stack size limit */
#define	MAXSSIZ		(32ULL * 1024ULL * 1024ULL * 1024ULL * 1024ULL)
#define	DFLSSIZ		(8*1024*1024 + ((USRSTACK) & 0x3FFFFF))	/* initial stack size limit */
